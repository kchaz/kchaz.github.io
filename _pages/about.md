...
- Missing data problems -- especially data combination, record linkage, and causal inference.
- Multi-phase inference -- data collection, de-duplication, privacy protection, and other aspects of data (pre)processing pipelines and their downstream consequences.
